...
namespace ExpediaTest
{
	...
	public class UserTest
	{
        ...
        [TestMethod()]
        public void TestRemoveFlightFromAvailableFlightsWhenBooked()
        {
            ServiceLocator serviceLocator = new ServiceLocator();
            var flightToBook = new Flight(new DateTime(2015, 1, 05), new DateTime(2015, 1, 09), 100);
            var remainingFlight = new Flight(new DateTime(2015, 1, 03), new DateTime(2015, 1, 09), 100);
